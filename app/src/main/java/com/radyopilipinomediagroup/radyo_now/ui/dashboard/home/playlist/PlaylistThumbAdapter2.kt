...
class PlaylistThumbAdapter2(var context: Context, var playlists: PlaylistListResultModel.Data) : RecyclerView.Adapter<PlaylistThumbAdapter2.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(playlists.thumbnail?.size!! >= 3){
            holder.playlistThumb.layoutParams.height = pxToDp(50F).toInt()
        }else holder.playlistThumb.layoutParams.height = pxToDp(95F).toInt()
