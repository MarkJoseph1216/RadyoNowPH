...
class PlaylistHeadThumbAdapter(var context: Context, var playlists: PlaylistListResultModel.Data) : RecyclerView.Adapter<PlaylistHeadThumbAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(playlists.thumbnail?.size!! >= 3){
            holder.playlistThumb.layoutParams.height = pxToDp(75F).toInt()
        }else holder.playlistThumb.layoutParams.height = pxToDp(150F).toInt()
